---
description: Fetch Wikipedia company summary for a ticker
---

# Run the fetch_wikipedia skill for the given ticker

**Arguments:** $ARGUMENTS (expects: SYMBOL --workdir DIR)

```bash
uv run ./skills/fetch_wikipedia/fetch_wikipedia.py $ARGUMENTS
```
